...
private:
    ...
    void color1(){
        ...
        int vX = _x + start;
        int vY = startH - _y;
        double sat = Plane::saturation(vX, vY, _cirleRadius);
...
///
Plane thePlane = Plane(_cirleRadius);
